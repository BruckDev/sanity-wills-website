...
export const metadata: Metadata = {
  ...
  description:
    'Prepare a private, attorney-review planning outline for a future will conversation.',
}
      ...
      <section className="rounded-[2rem] bg-[#071f33] px-6 py-12 text-white md:px-12 md:py-16">
        <div className="max-w-4xl">
          ...
          <h1 className="mt-5 font-serif text-5xl leading-[0.98] tracking-[-0.045em] md:text-7xl">
            Prepare a will outline before you meet an attorney.
          </h1>
          <p className="mt-7 max-w-3xl text-lg leading-8 text-white/80 md:text-xl">
            Answer a few questions to create a private planning summary you can print and take to an
            attorney. It is a discussion tool, not a legally valid will.
          </p>
        </div>
      </section>
