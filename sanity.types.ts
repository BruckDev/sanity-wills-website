...
export type Home = {
  ...
  display?: {
    ...
    heroReassuranceHeading?: string
    heroReassuranceText?: string
...
export type LifeEventQueryResult = {
  ...
  article: {
    ...
    sections: Array<{
      ...
      afterQuestions: Array<string> | null
      items: Array<{
        title: string | null
...
// Query: *[_type == "home"][0]{planningEyebrow, planChooserHeading, "attorneySearchBackground": attorneySearchBackground.asset->url, articleCards[0...6]{title, description, href, alt, "image": coalesce(image.asset->url, imagePath)}}
...
export type HomeQueryResult = {
  ...
  display: {
    ...
    heroReassuranceHeading: string | null
    heroReassuranceText: string | null
...
// Source: sanity/lib/siteQueries.ts
// Variable: homeHeroReassuranceQuery
// Query: *[_type == "home"][0]{    display{      heroReassuranceHeading,      heroReassuranceText    }  }
export type HomeHeroReassuranceQueryResult = {
  display: {
    heroReassuranceHeading: string | null
    heroReassuranceText: string | null
  } | null
...
declare module '@sanity/client' {
  interface SanityQueries {
    ...
    '*[_type == "home"][0]{planningEyebrow, planChooserHeading, "attorneySearchBackground": attorneySearchBackground.asset->url, articleCards[0...6]{title, description, href, alt, "image": coalesce(image.asset->url, imagePath)}}': HomeAppearanceQueryResult
