...
export function ButtonLink({href, label, style = 'primary', className = ''}: ButtonLinkProps) {
  ...
  const styles = {
    primary:
      'border border-[color:var(--accent)] bg-[color:var(--accent)] text-[#061e31] shadow-[0_10px_24px_rgba(7,31,51,0.16)] hover:-translate-y-0.5 hover:border-[color:var(--accent-strong)] hover:bg-[color:var(--accent-strong)] hover:text-[#061e31] hover:shadow-[0_14px_30px_rgba(7,31,51,0.22)] focus-visible:outline-[color:var(--accent)]',
    secondary:
